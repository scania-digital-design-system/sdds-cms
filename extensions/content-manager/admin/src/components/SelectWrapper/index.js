...
function SelectWrapper({
  ...
  const item = get(modifiedData, name, null);
  // Due to our setup using a object database we want to
  // have the possibility to sort items based on a property
  const value = Array.isArray(item) ? item.sort((a, b) => a.index > b.index ? 1 : -1) : item;
